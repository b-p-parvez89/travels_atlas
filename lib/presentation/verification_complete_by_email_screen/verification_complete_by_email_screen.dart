...
class VerificationCompleteByEmailScreen
    extends GetWidget<VerificationCompleteByEmailController> {
  const VerificationCompleteByEmailScreen({Key? key})
      : super(
          key: key,
        );
